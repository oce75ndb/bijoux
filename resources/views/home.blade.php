<x-app-layout :categories="$categories">
    ...
    <section class="font-sans bg-beige dark:bg-gold py-20 text-center animate-fade-in">
        ...
        <a href="/products" wire:navigate class="mt-6 inline-block bg-brown dark:bg-beige text-beige dark:text-brown py-2 px-4 rounded 
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
                ...
                @if ($produitA)
                    <div class="bg-white shadow-md rounded-lg p-4 border border-gold 
                                        ...
                                        animate-slide-up">
                        <img src="{{ asset($produitA->image) }}" alt="{{ $produitA->nom }}"
                        ...
                        <a href="{{ route('produit.show', ['id' => $produitA->id]) }}" class="block mt-4 bg-brown dark:bg-brown text-beige py-2 px-4 rounded text-center 
                                          hover:bg-gold transition-transform transform hover:scale-105 active:scale-95">
                            Voir le produit
                        </a>
                    </div>
                ...
                @if ($produitB)
                    <div class="bg-white shadow-md rounded-lg p-4 border border-gold 
                                        transition-transform transform hover:scale-105 active:scale-95 
                                        animate-slide-up">
                        <img src="{{ asset($produitB->image) }}" alt="{{ $produitB->nom }}"
                            class="w-full h-48 object-cover rounded">
                        <h4 class="text-lg font-bold text-brown dark:text-brown mt-4">
                            {{ $produitB->nom }}
                        </h4>
                        ...
                        <a href="{{ route('produit.show', ['id' => $produitB->id]) }}" class="block mt-4 bg-brown dark:bg-brown text-beige py-2 px-4 rounded text-center 
                                          hover:bg-gold transition-transform transform hover:scale-105 active:scale-95">
                            Voir le produit
                        </a>
                    </div>
                ...
                @if ($produitC)
                    <div class="bg-white shadow-md rounded-lg p-4 border border-gold 
                                        transition-transform transform hover:scale-105 active:scale-95 
                                        animate-slide-up">
                        <img src="{{ asset($produitC->image) }}" alt="{{ $produitC->nom }}"
                            class="w-full h-48 object-cover rounded">
                        <h4 class="text-lg font-bold text-brown dark:text-brown mt-4">
                            {{ $produitC->nom }}
                        </h4>
                        ...
                        <a href="{{ route('produit.show', ['id' => $produitC->id]) }}" class="block mt-4 bg-brown dark:bg-brown text-beige py-2 px-4 rounded text-center 
                                          hover:bg-gold transition-transform transform hover:scale-105 active:scale-95">
                            Voir le produit
                        </a>
                    </div>

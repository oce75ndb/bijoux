<x-app-layout :categories="$categories">
    ...
    <section class="font-sans bg-beige dark:bg-gold py-20 text-center animate-fade-in">
        ...
        <a href="/products" class="mt-6 inline-block bg-brown dark:bg-beige text-beige dark:text-brown py-2 px-4 rounded 
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
                ...
                @if ($produitA)
                    ...
                    class="block bg-white shadow-md rounded-lg p-4 border border-gold 
                            transition-transform transform hover:scale-105 active:scale-95 animate-slide-up">
                        ...
                        <span class="block mt-4 bg-brown dark:bg-brown text-beige py-2 px-4 rounded text-center 
                                    hover:bg-gold transition-transform transform hover:scale-105 active:scale-95">
                            Voir le produit
                        </span>
                    </a>

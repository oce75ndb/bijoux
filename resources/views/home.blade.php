<x-app-layout>
    ...
    <section class="bg-beige dark:bg-gold py-20 text-center">
        <h2 class="text-4xl font-bold text-black dark:text-brown">
        ...
        <a href="/products" 
           class="mt-6 inline-block bg-black dark:bg-beige text-beige dark:text-brown py-2 px-4 rounded 
    ...
    <section class="bg-beige dark:bg-gold">
        <div class="container mx-auto px-4">
            <h3 class="text-2xl font-bold text-center text-black dark:text-brown">
                Produits Vedettes
            </h3>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
                ...
                @if ($produitA)
                    <div class="bg-white shadow-md rounded-lg p-4 border border-gold 
                        ...
                        <h4 class="text-lg font-bold text-black dark:text-brown mt-4">
                            {{ $produitA->nom }}
                        </h4>
                        ...
                        <a href="{{ route('produit.show', ['id' => $produitA->id]) }}" 
                           class="block mt-4 bg-black dark:bg-brown text-beige py-2 px-4 rounded text-center hover:bg-gold">
                            Voir le produit
                        </a>
                    </div>
                @endif
